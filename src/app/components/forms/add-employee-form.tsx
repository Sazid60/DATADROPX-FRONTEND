...
import { createEmployeeSchema } from "@/app/zod/employee.validation";
...
const defaultFormValues: IEmployeePayload = {
    name: "",
    email: "",
    position: "",
    department: "",
...
const AddEmployeeForm = ({ onSuccess, onCancel }: AddEmployeeFormProps) => {
    const [formData, setFormData] = useState<IEmployeePayload>(defaultFormValues);
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        const validationResult = zodValidator(formData, createEmployeeSchema);
        ...
        try {
            ...
            const employee = await employeeManagement.createEmployee(formData);
